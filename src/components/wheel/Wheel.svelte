...
<div class="wheel-container">
    <div class="wheel">
        <div id="left-gutter">
            <button on:click={() => closeWheel()}><svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 24 24"><path fill="var(--highlight-color)" fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12m7.293-2.707a1 1 0 0 1 1.414 0L12 10.586l1.293-1.293a1 1 0 1 1 1.414 1.414L13.414 12l1.293 1.293a1 1 0 0 1-1.414 1.414L12 13.414l-1.293 1.293a1 1 0 0 1-1.414-1.414L10.586 12l-1.293-1.293a1 1 0 0 1 0-1.414" clip-rule="evenodd"/></svg><span>Close the wheel</span></button>
            <Bubble> <Tiltle variant="stress"> Customize search </Tiltle> </Bubble>
            <Search/>
            <CalenderSwitcher/>
            <LikedYears/>
        </div>
        <div id="middle-gutter">
            <div>
                <Bubble class="center">Bored of this ? 
